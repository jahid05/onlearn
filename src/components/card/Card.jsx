    ...
    <div>
      <div className="card card-compact bg-gray-100">
        ...
        <div className="card-body text-start h-52">
          ...
          <h2 className="text-lg font-semibold text-theme-1">{title}</h2>
          <p>{slogan}</p>
          <div className="card-actions justify-center py-2">
            ...
            <Link to={`/dashboard/updateCourse/${id}`} className="btn text-white bg-indigo-400">
              <FaRegPenToSquare />
            </Link>
            <button
